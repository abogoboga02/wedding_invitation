-- Jalankan blok ini terlebih dahulu dari database lain, misalnya "postgres"
DROP DATABASE IF EXISTS wedding_invitation;
CREATE DATABASE wedding_invitation;

-- Jika memakai psql, pindah koneksi dengan perintah ini:
-- \connect wedding_invitation
--
-- Jika memakai pgAdmin / DBeaver / GUI lain:
-- setelah CREATE DATABASE berhasil, buka database "wedding_invitation"
-- lalu jalankan sisa script mulai dari CREATE SCHEMA.
