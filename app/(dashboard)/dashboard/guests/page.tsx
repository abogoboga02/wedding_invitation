...
export default async function DashboardGuestsPage() {
  ...
  const rsvpGuests = invitation.guests.filter((guest) => guest.rsvp).length;

  return (
    <div className="space-y-6">
      <DashboardPageHeader
        eyebrow="Guest Management"
        title="Kelola tamu dan personal link"
        description="Tambah guest manual, edit data yang sudah ada, lalu bagikan personal link unik untuk setiap tamu."
      />
