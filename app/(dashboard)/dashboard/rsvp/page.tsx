...
import { getDashboardInvitationRsvpView } from "@/features/invitation/invitation.service";
...
export default async function DashboardRsvpPage() {
  ...
  const invitation = await getDashboardInvitationRsvpView(user.id);
  ...
  return (
    <div className="space-y-6">
      ...
      <DashboardSectionCard
        ...
        description="Menampilkan RSVP yang sudah masuk dari link tamu beserta nama responden, jumlah hadir, pesan singkat, dan ucapan."
      >
        <div className="space-y-3">
          {rsvps.length > 0 ? (
              ...
              return (
                ...
                >
                  <div>
                    ...
                    <p className="text-sm text-[var(--color-text-secondary)]">{publicPath}</p>
            ...
            <p className="rounded-[1.5rem] bg-[var(--color-surface-alt)] px-4 py-5 text-sm leading-7 text-[var(--color-text-secondary)]">
              Belum ada RSVP yang masuk. Setelah tamu membuka link undangan dan mengisi form,
